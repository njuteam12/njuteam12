...
<h1>消息中心&nbsp;&nbsp;
<small>
<button type="submit" name = "submit" value = "refresh" class="btn btn-success">刷新消息</button>
</small>
</h1>
...
<div class="panel-heading"><span class="label label-warning"><FONT COLOR:red>订单<%=i%>&nbsp;&nbsp;</FONT></span></div>
<div class="panel-body">
餐厅名：<%=Orders[i][2]%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
菜名：<%=Orders[i][3]%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
价格：<span class="label label-default">￥<%=Orders[i][4]%></span>
<hr>
</div>
<div class="panel-footer">
<table>
<tr><td>
<label for="exampleInputName2">预计到达时间：<%=Orders[i][5]%></label>
</td><td>
&nbsp;&nbsp;
</td>
<td>
...
<tr><td>
<input type="text" class="form-control" size = 10 name = <%=Orders[i][0]%> id="exampleInputName2" placeholder="给个评论吧" name = <%=Orders[i][0]%>></td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button type="submit" class="btn btn-danger" name = "submit" value = <%=Orders[i][0]%>>确认收货</button></td></tr></table>
</div>
</div>
